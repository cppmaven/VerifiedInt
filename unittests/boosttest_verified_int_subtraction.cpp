...
#define GEN_SUBTRACTION_TEST_CASES(TYPE) \
BOOST_AUTO_TEST_CASE(test_addition_verified_##TYPE) { \
    ...
    BOOST_CHECK_EQUAL(integer_traits<TYPE>::const_max, temp); \
    ...
    value = integer_traits<TYPE>::const_max; \
    BOOST_CHECK_NO_THROW( temp = --value; ); \
    BOOST_CHECK_EQUAL(integer_traits<TYPE>::const_max - 1, temp); \
    \
    value = integer_traits<TYPE>::const_min; \
    BOOST_CHECK_THROW( --value, boost::overflow_detected ); \
    \
    ...
    BOOST_CHECK_EQUAL(integer_traits<TYPE>::const_max - 1, value); \
    \
    value = integer_traits<TYPE>::const_min; \
...
GEN_SUBTRACTION_TEST_CASES(uint8_t)
GEN_SUBTRACTION_TEST_CASES(uint16_t)
GEN_SUBTRACTION_TEST_CASES(uint32_t)
GEN_SUBTRACTION_TEST_CASES(uint64_t)
GEN_SUBTRACTION_TEST_CASES(int8_t)
GEN_SUBTRACTION_TEST_CASES(int16_t)
GEN_SUBTRACTION_TEST_CASES(int32_t)
GEN_SUBTRACTION_TEST_CASES(int64_t)
#undef GEN_SUBTRACTION_TEST_CASES
} // namespace anonymous
